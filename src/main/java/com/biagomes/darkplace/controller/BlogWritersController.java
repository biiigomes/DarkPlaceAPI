...
public class BlogWritersController {
    ...
    @PostMapping
    public ResponseEntity<BlogWritersDTO> create(@Valid @RequestBody BlogWritersDTO blogWritersDTO){
        return new ResponseEntity<>(blogWritersService.create(blogWritersDTO), HttpStatus.CREATED);
    }
