...
public class CasesWithoutSolutionController {
    ...
    @PostMapping
    public ResponseEntity<CasesWithoutSolutionDTO> create(@Valid @RequestBody CasesRequestDTO casesWithoutSolutionDTO){
    ...
    public ResponseEntity<CasesWithoutSolutionDTO> update(
        @Valid 
        @RequestBody CasesRequestDTO casesWithoutSolutionDTO, 
